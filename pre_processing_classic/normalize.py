...
##-----------------------------------------------------------------------------
##  Function normalize(image, x_iris, y_iris, r_iris, x_pupil, y_pupil, 
##                      r_pupil, radpixels, angulardiv)
##-----------------------------------------------------------------------------
##  Description:
##      Normalize iris region by unwraping the circular region into a 
