...
from pre_processing_classic.boundary import searchInnerBound, searchOuterBound
from pre_processing_classic.line import findline, linecoords

import multiprocessing as mp

##-----------------------------------------------------------------------------
##  Function segment(eyeim, eyelashes_thres=80, use_multiprocess=True)
##-----------------------------------------------------------------------------
##  Description:
...
##-----------------------------------------------------------------------------
##  Function findTopEyelid(imsz, imageiris, irl, icl, rowp, rp, ret_top=None)
##-----------------------------------------------------------------------------
##  Description:
...
##-----------------------------------------------------------------------------
##  Function findBottomEyelid(imsz, imageiris, rowp, rp, irl, icl, ret_bot=None)
##-----------------------------------------------------------------------------
##  Description:
